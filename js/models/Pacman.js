...
// mesh shpere for the left shoulder 
this.leftShoulderSphere = new THREE.Mesh(ShoulderSphereGeometry, ShoulderSphereMaterial);
...
this.leftFinger1Connection = new THREE.Mesh(Finger1ConnectionHandGeometry, Finger1ConnectionHandMaterial);
this.leftFinger2Connection = new THREE.Mesh(Finger2ConnectionHandGeometry, Finger2ConnectionHandMaterial);
this.leftFinger3Connection = new THREE.Mesh(Finger3ConnectionHandGeometry, Finger3ConnectionHandMaterial);
this.leftThumbFingerConnection = new THREE.Mesh(ThumbFingerConnectionHandGeometry, ThumbFingerConnectionHandMaterial);
this.leftThumbFingerConnection.position.x = -0.7;
// mesh first finger left hand
this.firstFingerLeftHand = new THREE.Mesh(Finger1HandGeometry, Finger1HandMaterial);
// mesh second finger left hand
this.secondFingerLeftHand = new THREE.Mesh(Finger2HandGeometry, Finger2HandMaterial);
// mesh third finger left hand
this.thirdFingerLeftHand = new THREE.Mesh(Finger3HandGeometry, Finger3HandMaterial);
// // mesh thumb finger left hand
this.thumbFingerLeftHand = new THREE.Mesh(ThumbFingerHandGeometry, ThumbFingerHandMaterial);
...
//mesh shpere for the right shoulder 
this.rightShoulderSphere = new THREE.Mesh(ShoulderSphereGeometry, ShoulderSphereMaterial);
...
// fingers and there connections
this.rightFinger1Connection = new THREE.Mesh(Finger1ConnectionHandGeometry, Finger1ConnectionHandMaterial);
this.rightFinger2Connection = new THREE.Mesh(Finger2ConnectionHandGeometry, Finger2ConnectionHandMaterial);
this.rightFinger3Connection = new THREE.Mesh(Finger3ConnectionHandGeometry, Finger3ConnectionHandMaterial);
this.rightThumbFingerConnection = new THREE.Mesh(ThumbFingerConnectionHandGeometry, ThumbFingerConnectionHandMaterial);
this.rightThumbFingerConnection.position.x = 0.7;
// mesh first finger right hand
this.firstFingerRightHand = new THREE.Mesh(Finger1HandGeometry, Finger1HandMaterial);
// mesh second finger right hand
this.secondFingerRightHand = new THREE.Mesh(Finger2HandGeometry, Finger2HandMaterial);
// mesh third finger right hand
this.thirdFingerRightHand = new THREE.Mesh(Finger3HandGeometry, Finger3HandMaterial);
//mesh thumb finger right hand
this.thumbFingerRightHand = new THREE.Mesh(ThumbFingerHandGeometry, ThumbFingerHandMaterial);
...
// ------------------------------ PACMAN CONNECTIONS WITH THE MESHS ---------------------------------------------
